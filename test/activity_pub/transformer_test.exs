defmodule ActivityPub.Federator.TransformerTest do
  ...
  describe "handle incoming" do
    ...
    test "it works for incoming unlikes with an existing like activity" do
      ...
      {:ok, %Object{data: like_data, local: false}} = Transformer.handle_incoming(like_data)
      ...
      assert data["id"] ==
               "https://mastodon.local/users/admin#likes/2/undo"

      assert data["object"]["id"] ==
               "https://mastodon.local/users/admin#likes/2"
    end
